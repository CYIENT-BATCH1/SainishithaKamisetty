...
G_Msg_EngineInformation_Byte[3]=(G_Eng_EngineTemperature_uchar);           //0to7 are set in a[3] in Enginetemperature   

G_Msg_EngineInformation_Byte[0]=((G_Eng_EngineRpm_uint>>9)&1);             //9 to 12 are set in a[0] in EngineRPM                     

G_Msg_EngineInformation_Byte[2]=(G_Eng_EngineRpm_uint<<8);                 //0 bit to set in  a[2] in EngineRPM

G_Msg_EngineInformation_Byte[1]=((G_Eng_EngineRpm_uint>>1)&0xff);          // 1 to 8 are set in a[1] in EngineRPM
